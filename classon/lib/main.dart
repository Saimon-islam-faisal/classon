...
class _QuizScreenState extends State<QuizScreen> {
  ...
  List<List<String>> options = [
    ...
    ['Rakib', 'Ferdous','Faisal','Arif'],
    ['22','23','24','25'],
  ];

  List<String> correctAnswers = ['Paris', 'Leonardo da Vinci', 'Jupiter','Faisal','23'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Quiz App'),backgroundColor: Colors.lightBlueAccent
      ),
      body: Column(
        children: [
          Text(""),
