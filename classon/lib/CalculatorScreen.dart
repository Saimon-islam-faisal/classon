...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("CALCULATOR",style: TextStyle(fontSize: 55,fontWeight: FontWeight.bold))),backgroundColor: Colors.lightBlueAccent),
            ...
            children: [
              ...
              Expanded(
                child: Container(
                    ...
                    child: Text("$input\n$final_result",style: TextStyle(fontSize: 50, fontWeight: FontWeight.bold,color: Colors.black))
